...
// const initialNewClaimState = {policyNumber : thisClaim.policyNumber, 
//     date : new Date().toISOString().slice(0,10) , insuranceType: thisClaim.insuranceType, 
//     title: thisClaim.title, forename : thisClaim.forename, surname: thisClaim.surname, amount: thisClaim.amount, reason : thisClaim.reason,
//     updates : thisclaim.updates,  status : thisclaim.status}
